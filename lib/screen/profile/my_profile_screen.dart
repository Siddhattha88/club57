...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  TextEditingController deActivePasswordController = new TextEditingController();
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                actionsPadding: EdgeInsets.only(right: 15.0,bottom: 15.0),
                actions: <Widget>[
                  GestureDetector(
                      onTap: () {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: EditTextUtils().getCustomEditTextField(
                  ...
                  controller: deActivePasswordController,
                  prefixWidget: Container(
                    width: 1.0,
                    height: 1.0,
                  ),
  ...
  accountDeactivate(context) async {
    _accountDeactivate = await Repository().accountDeactivate(
        deActivePasswordController.text,userId: userId, reason: accountDeactivateReasonController.value.text);
