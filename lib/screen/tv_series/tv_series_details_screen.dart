...
class _TvSerisDetailsScreenState extends State<TvSerisDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(top: false,child: FutureBuilder<TvSeriesDetailsModel?>(
            future: dataFuture,
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                ...
                                return Image.asset(
                                  'assets/logo.png', // Path to your placeholder image
                                  fit: BoxFit.fill,
                                );
                              },
                            ),
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              ...
                              fit: BoxFit.fill,
                              errorBuilder: (context, error, stackTrace) {
                                // Show fallback image if the URL does not contain a valid image
                                return Image.asset(
                                  'assets/logo.png',
                                  fit: BoxFit.fill,
                                );
          ...
          itemBuilder: (BuildContext context, int index) {
            return InkWell(
              onTap: () {
                ...
                selectedSeason.value = data.season!.first;
                setState(() {});
              },
              child: Padding(
                padding: const EdgeInsets.all(8.0),
