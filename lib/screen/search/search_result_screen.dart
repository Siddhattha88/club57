  ...
  Widget buildUI(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: <Widget>[
        ...
        if(_resultModel!.movie!.isEmpty && _resultModel!.tvSeries!.isEmpty && _resultModel!.tvChannels!.isEmpty)
          SliverToBoxAdapter(
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: MediaQuery.of(context).size.height * 0.4),
              child: Center(child: Text("No item Found !", style: isDark! ? CustomTheme.bodyText2White : CustomTheme.bodyText2),
              ),
            ),
          ),
