                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  final formatCurrency = NumberFormat.simpleCurrency(locale: Localizations.localeOf(context).toString());
                                  final formattedPrice = formatCurrency.format(double.tryParse(data.package![index].price.toString()) ?? 0.0);
                                  return InkWell(
                                    onTap: () {
                                            ...
                                            children: [
                                              FittedBox(
                                                child: Text(
                                                  formattedPrice,
                                                  textAlign: TextAlign.center,
                                                  style: CustomTheme.bodyText1White.copyWith(
                                                    fontSize: 14,
