  ...
  Future<void> requestReview() async {
    try {
      if (await _inAppReview.isAvailable()) {
        // Requests a review dialog from the user
        await _inAppReview.requestReview();
      } else {
        // If review dialog isn't available, redirect to store listing
        await _inAppReview.openStoreListing(
          appStoreId: _packageInfo.packageName, // Replace with your iOS app ID
          microsoftStoreId: _packageInfo.data['microsoft_store_id'], // If applicable
        );
      }
    } catch (e) {
