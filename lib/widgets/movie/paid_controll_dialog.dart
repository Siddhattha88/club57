                  ...
                  child: Padding(
                    ...
                    child: ListView(
                      children: [
                        ...
                        if (paymentConfig!.razorpayEnable == true)
                          InkWell(
                            onTap: () async {
                        ...
                        if (paymentConfig.razorpayEnable == true) Divider(
                          color: Colors.grey,
                        ),
                        ...
                        if (paymentConfig.paypalEnable == true) Divider(
                          color: Colors.grey,
                        ),
                        ...
                        //offline
                        if (paymentConfig.stripeEnable == true) Divider(
                          color: Colors.grey,
                        ),
                        if (paymentConfig.stripeEnable == true)
                          InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          textAlign: TextAlign.center,
                                          style:
                                          Theme.of(context).textTheme.headlineMedium?.copyWith(color: Colors.white,fontSize: 18) as TextStyle,
