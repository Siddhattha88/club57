                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    switch (videos
                                      ...
                                      case "youtube":
                                        {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => MovieDetailsYoutubePlayer(url: videos.elementAt(index).fileUrl!)));
                                        }
                                        break;
                                      case "mp4":
                                        {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => FlickPlayer(subtitles: videos.elementAt(index).subtitle!.length != 0 ? videos.elementAt(index).subtitle : null, type: videos.elementAt(index).fileType!, url: videos.elementAt(index).fileUrl!)));
                                          //statements;
                                        }
                                        break;
                                      default:
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    print("---------video_type:${videos.elementAt(index).fileType!.toLowerCase()}");
                                    Navigator.of(context).pop();
                                    switch (videos
                                        .elementAt(index)
                                        .fileType!
                                      ...
                                      case "embed":
                                        {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => EmbedPlayer(url: videos.elementAt(index).fileUrl!)));
                                        }
                                        break;
