...
class RegistrationBloc extends Bloc<RegistrationEvent, RegistrationState> {
  ...
  Future<void> _onRegistrationEvent(RegistrationEvent event, Emitter<RegistrationState> emit) async {
    emit(RegistrationStartedState());
    try {
      if (event is RegistrationCompleting) {
        ...
        emit(RegistrationStateCompleted(userServerData));
      }
    } catch (e) {
